  ...
  return (
    <div className='flex w-full h-10 bg-box-bg-color rounded-xl pr-5 pl-5'>
      ...
      <div className='flex w-1/5 mt-auto mb-auto gap-2 justify-end'>
        <button className='flex w-16 border border-box-line-color rounded-lg justify-center text-sm'>수정</button>
        <button className='flex w-16 border border-box-line-color rounded-lg justify-center text-sm'>취소</button>
      </div>
    </div>
  )
}
