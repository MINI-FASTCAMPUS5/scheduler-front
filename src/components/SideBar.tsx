...
export default function SideBar() {
  ...
  return (
    <div className='relative bg-slate-300 min-w-[12rem] sm:min-w-[15rem] md:min-w-[18rem] transition-all ease-out duration-75 p-2 z-[100]'>
      <aside className='fixed sm:min-w-[15rem] md:min-w-[18rem] transition-all ease-out duration-75 p-2'>
