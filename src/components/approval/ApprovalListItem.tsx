    ...
    case 'WAITING':
      buttonState = (
        <div className='flex gap-2'>
          <button onClick={handleApprove} className='flex w-[calc(3vw+5px)] text-[calc(1vw-5px)] border text-wait border-wait rounded-lg justify-center text-sm transition hover:bg-wait hover:text-white'>
            승인하기
          </button>
